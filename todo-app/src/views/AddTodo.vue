...
export default {
    ...
    methods: {
        ...mapActions(useTodoStore, ['addTodoHandler']),
...
<template>
    <div class="px-12 py-12">
        ...
        <div class="mx-auto max-w-screen-xl px-4 py-2 sm:px-6 lg:px-8">
            ...
            <form class="mx-auto mt-8 mb-0 max-w-md space-y-4" @submit.prevent="addTodo">
                <div>
                    <label>Title</label>

                    <div class="relative">
                        <input type="text" class="w-full rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm"
                            placeholder="Enter title" v-model="newTodoTitle" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" class="w-full rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm"
                            placeholder="Enter description" v-model="newTodoDescription" />
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="date" class="w-full rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm"
                            placeholder="Enter description" v-model="newTodoDeadline" />
